...
export default async function PublicBookingPage({ params, searchParams }: { params: Promise<{ slug: string }>; searchParams?: Promise<Record<string, string | string[] | undefined>> }) {
  ...
  const error = typeof query.error === "string" ? query.error : ""; const hold = typeof query.hold === "string" ? query.hold : ""; const deposit = Number(typeof query.deposit === "string" ? query.deposit : 0);
